        ...
        <div class="col-md-10">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a class="a-b-o" href="text.php">Текст</a></li>
                </ol>
            </nav>
        </div>
        <div class="col-md-1">
        ...
        <div class="col-md-10 mx-auto" style="background-color: white;min-height: 25rem;">
            ...
            <div class="container">
                <form class="m-5" action="text.php" method="post">
                    <label class="form-label" for="checkbox">Выберите отображать задачи №5, №9, №17 или нет:</label>
                    <p>Задача №5: <input type="checkbox" name="checkbox5" id="checkbox" value="5"></p>
                    <p>Задача №9: <input type="checkbox" name="checkbox9" id="checkbox" value="9"></p>
                    <p>Задача №17: <input type="checkbox" name="checkbox17" id="checkbox" value="17"></p>
            ...
            <div class="container">
                <?php if(!empty($task['header'])){echo $task['header'];} ?>
                <?php if(!empty($task['task5'])){echo $task['task5'];} ?>
                <?php if(!empty($task['task9'])){echo $task['task9'];} ?>
                <?php if(!empty($task['task15'])){echo $task['task15'];} ?>
                <?php if(!empty($task['task17'])){echo $task['task17'];} ?>
